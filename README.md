...
|------|------------|-----------|
| **0. Временные ряды как реализация случайного процесса** | <ul><li>Основные концепции и определения</li><li>Основные манипуляции с рядами</li><li>Что такое качественный прогноз<li>Метрики качества точечного прогноза</li></ul> | [Adeshere: Введение в TS](https://habr.com/ru/articles/542638/) |
